class IsValid {
  static fullname(str) {
    ...
    if (str.length < minTextLength) {
      return [
        true,
        `Per trumpas tekstas, turi buti minimum ${minTextLength} simboliai`,
      ];
    }
    ...
    for (const word of words) {
      if (word.length < minWordLength) {
        return [
          true,
          `Visos vardo dalys turi buti minimum ${minWordLength} simboliu`,
        ];
      }
  ...
  static password(str) {
    ...
    if (str.length < minPasswordLength) {
      return [
        true,
        `Per trumpas password tekstas, turi buti minimum ${minPasswordLength} simboliai`,
      ];
    }
